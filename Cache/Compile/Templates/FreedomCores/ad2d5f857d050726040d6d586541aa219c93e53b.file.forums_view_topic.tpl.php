<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-06-03 20:56:54
         compiled from "/opt/lampp/htdocs/Templates/FreedomCore/pages/forums_view_topic.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1543589906575011e61221c9-49041696%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ad2d5f857d050726040d6d586541aa219c93e53b' => 
    array (
      0 => '/opt/lampp/htdocs/Templates/FreedomCore/pages/forums_view_topic.tpl',
      1 => 1464976066,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1543589906575011e61221c9-49041696',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_575011e6329bf6_58772159',
  'variables' => 
  array (
    'AppName' => 0,
    'TopicData' => 0,
...
<?php if ($_valid && !is_callable('content_575011e6329bf6_58772159')) {function content_575011e6329bf6_58772159($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/opt/lampp/htdocs/Core/Libraries/Smarty/plugins/modifier.date_format.php';
...
">
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['AccesUser']->value['access_level']) {?>
                            <a class="ui-button request-sticky button2" href="/forum/topic/<?php echo $_smarty_tpl->tpl_vars['TopicData']->value['topic']['id'];?>
/delete" data-tooltip="<?php echo $_smarty_tpl->getConfigVariable('Forum_Make_It_Sticky_Full');?>
">
                                <span class="button-left">
                                    <span class="button-right">
                                        Delete
                            ...
                            <a class="ui-button request-sticky button2" href="/forum/topic/<?php echo $_smarty_tpl->tpl_vars['TopicData']->value['topic']['id'];?>
/open" data-tooltip="<?php echo $_smarty_tpl->getConfigVariable('Forum_Make_It_Sticky_Full');?>
">
                                <span class="button-left">
                                    <span class="button-right">
                                        Open Topic
                            ...
                            <?php } else { ?>
                             <a class="ui-button request-sticky button2" href="/forum/topic/<?php echo $_smarty_tpl->tpl_vars['TopicData']->value['topic']['id'];?>
/closed" data-tooltip="<?php echo $_smarty_tpl->getConfigVariable('Forum_Make_It_Sticky_Full');?>
">
                                <span class="button-left">
                                    <span class="button-right">
                                        Closed Topic
                            ...
                            <?php }?>
                            <?php if ($_smarty_tpl->tpl_vars['TopicData']->value['category']['attached']) {?>
                            <a class="ui-button request-sticky button2" href="/forum/topic/<?php echo $_smarty_tpl->tpl_vars['TopicData']->value['topic']['id'];?>
/unsticky" data-tooltip="<?php echo $_smarty_tpl->getConfigVariable('Forum_Make_It_Sticky_Full');?>
">
                                <span class="button-left">
                                    <span class="button-right">
                                        Unsticky Topic
                            ...
                            <?php } else { ?>
                             <a class="ui-button request-sticky button2" href="/forum/topic/<?php echo $_smarty_tpl->tpl_vars['TopicData']->value['topic']['id'];?>
/sticky" data-tooltip="<?php echo $_smarty_tpl->getConfigVariable('Forum_Make_It_Sticky_Full');?>
">
                                <span class="button-left">
                                    <span class="button-right">
                                        Sticky Topic
...
<a class="ui-button button2 quote-post" href="#new-post" onclick="ForumTopic.quoteTopic(this, '<?php echo $_smarty_tpl->tpl_vars['TopicData']->value['topic']['id'];?>
')" data-post-id="<?php echo $_smarty_tpl->tpl_vars['Reply']->value['post_id'];?>
"><span class="button-left"><span class="button-right">Quote
</span></span></a>
<?php }?>
<?php if ($_smarty_tpl->tpl_vars['AccesUser']->value['id']==$_smarty_tpl->tpl_vars['Reply']->value['user_id']) {?>
<a class="ui-button button2" href="/forum/topic/<?php echo $_smarty_tpl->tpl_vars['Reply']->value['id'];?>
/deleteTopicUser"  data-tooltip="Posts may be deleted within 15 minutes of posting."><span class="button-left"><span class="button-right">Delete</span></span></a>
<a class="ui-button button2" href="/forum/topic/<?php echo $_smarty_tpl->tpl_vars['Reply']->value['id'];?>
/edit"
