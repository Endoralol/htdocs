<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-06-04 03:37:33
         compiled from "/opt/lampp/htdocs/Templates/FreedomCore/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:101906401457521ca65489e7-41012604%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '101906401457521ca65489e7-41012604',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_57521ca6611f17_25112064',
  'variables' => 
  array (
    'Language' => 0,
    'Page' => 0,
...
<?php if ($_valid && !is_callable('content_57521ca6611f17_25112064')) {function content_57521ca6611f17_25112064($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("head.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
				...
				<form action="/search" method="get" autocomplete="off">
					<div>
						<div class="ui-typeahead-ghost">
							<input type="text" value="" autocomplete="off" readonly="readonly" class="search-field input input-ghost" style="left: 48px;">
							<input type="search" class="search-field input" name="q" id="search-field" maxlength="200" tabindex="40" alt="" value="" style="left: 48px;">						</div>
						<input type="submit" class="search-button" value="" tabindex="41" style="right: -6px;">					</div>
				</form>
			</div>
			<h1 id="logo">
