                                        ...
                                        <span class="account-link">
                                            ...
                                            <span class="account-id">
                                                <span class="account-edition">
                                                    <strong style="color: #4e4e4e!important;">{#Administrator_Users_Registered_Today#}</strong> {$UserAccount}
                                                </span>
                                            </span>
                                            <span class="account-region">
                                                <strong style="color: #4e4e4e!important;">{#Administrator_Users_Registered_Total#}</strong> {$UserAccountBan}
                                            </span>
                                        </span>
                                    </span>
                                </li>
                                <li class="border-4" style="background: #ededeb;">
                                    <span class="account-info">
                                        <span class="account-link">
                                            ...
                                            <span class="account-region">
                                                <strong style="color: #4e4e4e!important;">{#Administrator_Shop_Items_Price#}:</strong> {$ShopData.total} RUB
                                            </span>
                                        </span>
                                    </span>
                                </li>
