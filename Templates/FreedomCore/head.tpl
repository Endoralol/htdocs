...
<head xmlns:og="http://ogp.me/ns#" xmlns:fb="http://ogp.me/ns/fb#">
    ...
    <!--[if IE 6]> <link rel="stylesheet" type="text/css" media="all" href="//{$smarty.server.HTTP_HOST}/Templates/{$Template}/css/media/media-ie6.css" />
    <![endif]-->
    {/if}
    ...
    {/if}
    {if $Page.type == 'forum' || $Page.type == 'bugtracker'}
