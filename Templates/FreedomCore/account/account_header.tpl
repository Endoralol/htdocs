                    ...
                    <ul>
                        ...
                        <li {if $Page.type == 'account_operations'}class="active"{/if}>
                            ...
                            <div class="flyout-menu" id="activity-menu" style="display: none">
                                <ul>
                                    <li><a href="/account/management/balance">{#Account_Management_Wallet_TopUP#}</a></li>
                        ...
                        <li class="account-balance account-balance-rub" id="accountBalanceCenter" data-tooltip-options="{ldelim}&quot;location&quot;: &quot;mouse&quot;{rdelim}">
                            <a href="#" class="border-3 menu-arrow title" onclick="openAccountDropdown(this, 'accountBalance'); return false;">
                                ...
                                <span class="balance" >{$User.balance} {$User.selected_currency} </span>
                            </a>
                            <div class="flyout-menu" id="accountBalance-menu">
                                <ul>
                                    <li id="RUB" class="switch-currency selected"><span>{$User.balance} {$User.selected_currency} </span></li>
                                    <li class=" first"><a href="/account/management/balance">{#Account_Management_Wallet_TopUP#}</a></li>
