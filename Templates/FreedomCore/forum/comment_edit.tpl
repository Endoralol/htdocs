<form id="new-post" action="/forum/topic/{$TopicData.topic.id}/sendEdit" novalidate="novalidate" method="post" class="topic-form ajax-update" data-max-post-length="50000">
    <fieldset>
        <input type="hidden" name="csrftoken" value="{$CSRFToken}" />
        <input type="hidden" name="idpost" value="{$TopicData.topic.ids}" />
        <input type="hidden" name="idtopic" value="{$TopicData.topic.id}" />
    ...
    <div class="topic-form-wrapper">
        ...
        <div id="post-edit">
            <textarea id="commentTextArea" name="postCommand.detail" class="post-editor" maxlength="10000">{$TopicData.topic.post_message}</textarea>
