...
deletePost:function(a,b){
    ...
    $.ajax({url:Core.baseUrl+"/forum/topic/"+a+"/deleteTopicUser",type:"POST",
    data:{
        xstoken:Cookie.read("xstoken")
    },
    dataType:"json",
            ...
            else
            {
                if(c.status=="postDeleted")
                {
                    ...
                    if(c.anchor!=0)
                    {
                        ...
                        location.href.replace(d);location.reload(true);
                        }
                    else
                    {
...
error:function(c){Overlay.open(c.statusText);
}
}
);
return true;},
    ...
    quoteTopic: function(b) {
        ...
        FinalHTML = '[quote="'+a+'" class="quote-public"]' + PostHTML + '[/quote]';
